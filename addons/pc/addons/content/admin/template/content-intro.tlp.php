                ...
                <div class="config-items">
					...
					<div class="result-content" id="content_panel_1">
                        <table width="100%" class="insert-tab">
                            <tbody>
								<tr class="formtr">
                                    <th class="formth" width="12%"><i class="require-red">*</i>公司介绍：</th>
                                    <td class="formtd" >
                                    {php Form::loadForm('content');}
                                    {php echo Form::baiduEditor('公司介绍','pc_content_intro',$pc_content_intro);}
                                    <!-- <textarea rows="18" cols="90" name="pc_content_intro" >{$pc_content_intro}</textarea> -->
