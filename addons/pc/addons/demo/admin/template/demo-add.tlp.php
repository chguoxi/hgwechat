        ...
        <div class="result-wrap">
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <div class="config-items">
                    <div class="admin-nav">
                        <div class="nav">
                            <a href="{__PW_PATH__}{__ADMIN_FILE__}?mod={$mod}&file={$file}&action=manage">Demo管理</a>
                            {if $_roleid==-1}<a href="{__PW_PATH__}{__ADMIN_FILE__}?mod={$mod}&file={$file}&action=add" class="hover">添加Demo</a>{/if}
                        </div>
                    </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <td class="formtd"><input type="text" size="36" name="info[title]" class="common-text"></td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>内容：</th>
                                    <td class="formtd">{Form::baiduEditor('info','content','请输入您的内容')}</td>
                                </tr>
								<tr class="formtr">
                                    <th class="formth"></th>
                                    <td class="formtd">
