    ...
    <script language="javascript" type="text/javascript">
		...
		function appendModuleElement()
		{
			var lihtml='<li>菜单图标：<input type="hidden" class="common-text" name="menu[ico]['+ct+']" id="module_diy_demo_ico_value_'+ct+'" value="17" />';
				...
				lihtml+='<br>菜单URL：<?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=<span class="nowmodaction">'+$('#folder').val()+'</span>&file=<span class="nowmodaction">'+$('#folder').val()+'</span>&action= <input type="text" class="common-text" name="menu[action]['+ct+']" placeholder="菜单action" size="8" /></li>';
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                ...
                                <tr class="formtr">
                                    ...
                                    <br>
                                    菜单URL：<?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=<span class="nowmodaction"></span>&file=<span class="nowmodaction"></span>&action= <input type="text" class="common-text" name="menu[action][0]" value="config" size="8" />  
                                    &nbsp;&nbsp;
