...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">性能优化</span></div>
        </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <textarea class="common-textarea" cols="55" rows="5" name="info[memcache_host]"><?php echo isset($PW['memcache_host'])?$PW['memcache_host']:'';?></textarea>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[memcache_port]" value="<?php echo isset($PW['memcache_port'])?$PW['memcache_port']:'';?>" size="4" />
                                 ...
                                 <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[memcache_timeout]" value="<?php echo isset($PW['memcache_timeout'])?$PW['memcache_timeout']:'';?>" size="4" /> 秒
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[cache_mysql_db]" value="<?php echo isset($PW['cache_mysql_db'])?$PW['cache_mysql_db']:'';?>" size="4" /> 张
                                 ...
                                 <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[cache_ttl]" value="<?php echo isset($PW['cache_ttl'])?$PW['cache_ttl']:'';?>" size="4" /> 秒
