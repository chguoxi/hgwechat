...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">邮件配置</span></div>
        </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <label><input type="radio" class="common-radio" name="info[mail_type]"  <?php if(strtolower(substr(PHP_OS,0,3))=='win') { ?> disabled="disabled"<?php }?> value="2"  <?php echo $PW['mail_type']==2?'checked="checked"':'';?>/>通过mail函数发送（仅*unix类主机支持）</label><br />
                                    <label><input type="radio" class="common-radio" name="info[mail_type]"  <?php if(strtolower(substr(PHP_OS,0,3))!='win') { ?> disabled="disabled"<?php }?> value="3"  <?php echo $PW['mail_type']==3?'checked="checked"':'';?>/>通过SOCKET连接SMTP服务器发送（仅Windows主机支持）</label>
                                    </td>
                                </tr>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[mail_server]" value="<?php echo isset($PW['mail_server'])?$PW['mail_server']:'';?>" size="45" />
                                    </td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>邮件发送端口：</th>
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[mail_port]" value="<?php echo isset($PW['mail_port'])?$PW['mail_port']:'';?>" size="2" />
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[mail_user]" value="<?php echo isset($PW['mail_user'])?$PW['mail_user']:'';?>" size="45" />
                                    </td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>发送邮箱密码：</th>
                                    <td class="formtd">
                                    <input type="password" class="common-text" name="info[mail_pwd]" value="<?php echo isset($PW['mail_pwd'])?$PW['mail_pwd']:'';?>" size="45" />
                                    </td>
                                </tr>
                            </tbody></table>
                    </div>
