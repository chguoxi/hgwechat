...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>statics/core.css?t=1"/>
...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">上传配置</span></div>
        </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <td class="formtd"><input type="text" value="<?php echo isset($PW['upload_size_limit'])?$PW['upload_size_limit']:'';?>" size="2" name="info[upload_size_limit]" class="common-text"> M</td>
                                </tr>

                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>图片生成缩略图大小：</th>
                                    <td class="formtd">
                                    中等缩略图宽度 <input type="text" value="<?php echo isset($PW['upload_thumb1_width'])?$PW['upload_thumb1_width']:'';?>" size="2" name="info[upload_thumb1_width]" class="common-text"> Px
                                    &nbsp;&nbsp;
                                    小缩略图宽度 <input type="text" value="<?php echo isset($PW['upload_thumb2_width'])?$PW['upload_thumb2_width']:'';?>" size="2" name="info[upload_thumb2_width]" class="common-text"> Px
                                    </td>
                                </tr>
                                <tr class="formtr">
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    原图宽度大于 <input type="text" value="<?php echo isset($PW['upload_watermark_width'])?$PW['upload_watermark_width']:'';?>" size="2" name="info[upload_watermark_width]" class="common-text"> Px
                                    &nbsp;&nbsp;
                                    原图高度大于 <input type="text" value="<?php echo isset($PW['upload_watermark_height'])?$PW['upload_watermark_height']:'';?>" size="2" name="info[upload_watermark_height]" class="common-text"> Px
                                    </td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth" width="20%"><i class="require-red">*</i>水印透明度：</th>
                                    <td class="formtd"><input type="text" value="<?php echo isset($PW['upload_watermark_pct'])?$PW['upload_watermark_pct']:'';?>" size="2" name="info[upload_watermark_pct]" class="common-text">
