...
<body>
                ...
                <div class="config-items">
					...
					<div class="result-content" id="content_panel_1">
                        <table width="100%" class="insert-tab">
                            <tbody>
								<tr class="formtr">
                                    <th class="formth" width="20%"><i class="require-red">*</i>每页显示产品数</th>
                                    <td class="formtd">
                                 	<input type="text" class="common-text" name="config[pc_products_seo_title]" value="<?php echo isset($PW['pc_products_seo_title'])?$PW['pc_products_seo_title']:'';?>" size="36" />
                                    </td>

                                </tr>
                                <!--
                                您可以无限拓展配置的选项 不过值请以 pc_products_ 开头，以防止跟其他模块选项值冲突
                                您可以在前台用 $PW['pc_products_example'] 读取这个选项

                                <tr class="formtr">
                                    <th class="formth" width="20%"><i class="require-red">*</i>选项：</th>
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="config[pc_products_example]" value="<?php echo isset($PW['pc_products_example'])?$PW['pc_products_example']:'';?>" size="36" />
                                    </td>
    ...
    <div class="statics-footer"> 微私募 V<?php echo defined('PHPWECHAT_VERSION')?PHPWECHAT_VERSION:'{__PHPWECHAT_VERSION__}';?><?php echo defined('PHPWECHAT_RELEASE')?PHPWECHAT_RELEASE:'{__PHPWECHAT_RELEASE__}';?> © , Processed in <?php echo microtime()-$PW['time_start'];?> second(s) , <?php echo MySql::$mQuery;?> queries <a href="#">至顶端↑</a></div>
</body>
</html>