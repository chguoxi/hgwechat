        ...
        <div class="result-wrap">
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <div class="config-items">
                    <ul class="toggle-ul">
						<li class="hover" style="border-left:#F3F3F3 1px solid" id="title_panel_1" onClick="panelToggle(1,1,'panel');"><a href="javascript:void(0);">公司介绍配置</a></li>
					</ul>
					<div class="result-content" id="content_panel_1">
                        <table width="100%" class="insert-tab">
                            <tbody>
								<tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>公司介绍：</th>
                                    <td class="formtd">
                                    <textarea rows="18" cols="90" name="config[pc_content_intro]" ><?php echo isset($PW['pc_content_intro'])?$PW['pc_content_intro']:'';?></textarea>
                         
                                    </td>

                                </tr>
                                <!--
                                您可以无限拓展配置的选项 不过值请以 pc_content_ 开头，以防止跟其他模块选项值冲突
                                您可以在前台用 $PW['pc_content_example'] 读取这个选项

                                <tr class="formtr">
                                    <th class="formth" width="20%"><i class="require-red">*</i>选项：</th>
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="config[pc_content_example]" value="<?php echo isset($PW['pc_content_example'])?$PW['pc_content_example']:'';?>" size="36" />
                                    </td>
