...
<body>
<div class="header"><h3 class="logo"><font>☏ <?php echo isset($PW['contact_telephone'])?$PW['contact_telephone']:'';?></font>微私募</h3></div>
<div class="main">
	<div class="erweima">
...
<div class="footer">
  <span style="display:none;">© , Processed in <?php echo microtime()-$PW['time_start'];?> second(s) , <?php echo MySql::$mQuery;?> queries </span>
<br />
