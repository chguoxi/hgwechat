                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <td class="formtd"><input type="text" value="<?php echo isset($PW['pc_site_url'])?$PW['pc_site_url']:'';?>" size="24" name="info[pc_site_url]" class="common-text"></td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>PC站点名称：</th>
                                    <td class="formtd"><input type="text" value="<?php echo isset($PW['pc_site_name'])?$PW['pc_site_name']:'';?>" size="65" name="info[pc_site_name]" class="common-text"></td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>PC站点标题：</th>
                                    <td class="formtd"><input type="text" value="<?php echo isset($PW['pc_site_title'])?$PW['pc_site_title']:'';?>" size="65" name="info[pc_site_title]" class="common-text"></td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>PC站点关键字：</th>
                                    <td class="formtd"><input type="text" value="<?php echo isset($PW['pc_site_keywords'])?$PW['pc_site_keywords']:'';?>" size="65" name="info[pc_site_keywords]" class="common-text"></td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>PC站点描述：</th>
                                    <td class="formtd"><textarea class="common-textarea" cols="75" rows="5" name="info[pc_site_description]"><?php echo isset($PW['pc_site_description'])?$PW['pc_site_description']:'';?></textarea></td>
                                </tr>
                                <tr class="formtr">
								...
								<tr class="formtr">
                                    ...
                                    <td class="formtd">
									<textarea class="common-textarea" cols="75" rows="5" name="info[pc_site_copyright]"><?php echo isset($PW['pc_site_copyright'])?$PW['pc_site_copyright']:'';?></textarea></td>
                                </tr>
								<tr class="formtr">
                                    <th class="formth"></th>
                                    <td class="formtd">
