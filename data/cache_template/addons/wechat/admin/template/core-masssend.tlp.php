...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">群发信息</span></div>
        </div>
            ...
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <div class="config-items">     
					<div class="admin-nav">
                        <h2>群发信息</h2>
                        <div class="nav">
                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=<?php echo isset($mod)?$mod:'';?>&file=<?php echo isset($file)?$file:'';?>&action=<?php echo isset($action)?$action:'';?>" class="hover">群发信息</a>
                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=<?php echo isset($mod)?$mod:'';?>&file=<?php echo isset($file)?$file:'';?>&action=masssend_list">已发送</a>
                        </div>
     ...
     <div id="image-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
                ...
                $('#wechat_masssend_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();"><img src="<?php echo format_url($r['local_url']);?>" style="width:155px; height:152px" /></li>
				<?php $no++;}?>
            </ul>
        </div>
        <a class="close-reveal-modal">&#215;</a>
