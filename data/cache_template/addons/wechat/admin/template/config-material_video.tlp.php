    ...
    <div class="ifame-main-wrap">
        ...
        <div class="material-list">
			...
			<div class="nav">
				...
				<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_video" class="hover">视频</a>
			</div>
			<div class="btn-post">
				...
				<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=video_material_synchronism" class="a-btn-post" style="width:165px;"><i class="icon-font">&#xe025;</i> 一键同步视频素材库</a>
			</div>
			<?php if($data) { ?>
			<ul id="container">
			...
			<li  class="grid">
				...
				<div class="modify"><a href="<?php echo isset($r['remote_url'])?$r['remote_url']:'';?>" target="_blank" title="播放" class="play"><i class="icon-font">&#xe035;</i></a><a onClick="if(!confirm('确定删除该视频吗？')){return false;}" href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_delete&type=Video&id=<?php echo isset($r['id'])?$r['id']:'';?>" class="delete"><i class="icon-font">&#xe061;</i></a></div>
			</li>
			<?php $no++;}?>
			</ul>
