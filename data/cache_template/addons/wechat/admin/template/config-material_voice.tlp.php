    ...
    <div class="ifame-main-wrap">
        ...
        <div class="material-list">
			...
			<div class="nav">
				...
				<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_voice" class="hover">语音</a>
			...
			<div class="btn-post">
				...
				<a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=voice_material_synchronism" class="a-btn-post" style="width:165px"><i class="icon-font">&#xe025;</i> 一键同步语音素材库</a>
			</div>
			<?php if($data) { ?>
			<ul id="container">
			<?php $no=1;if(is_array($data))foreach($data as $r){?>
				<li>
					...
					<div class="modify"><a href="<?php echo format_url($r['local_url']);?>" target="_blank" title="播放" class="view"><i class="icon-font">&#xe035;</i></a><a onClick="if(!confirm('确定删除该语音素材吗？')){return false;}" href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=material_delete&type=Voice&id=<?php echo isset($r['id'])?$r['id']:'';?>" class="delete"><i class="icon-font">&#xe061;</i></a></div>
				</li>
			<?php $no++;}?>
			</ul>
