          ...
          <form name="myform" id="myform" action="" method="post">
              ...
              <div class="admin-nav">
                ...
                <div class="nav">
                    ...
                    <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=core&action=youaskservice_onlie" class="hover">在线客服</a>
              ...
              <div class="result-content">
                  <table class="result-tab" width="100%">
                      ...
                      <tr>
                          ...
                          <td><?php if($r['status']==1) { ?>PC在线<?php }elseif($r['status']==2){ ?>手机在线<?php }else{ ?>PC和手机同时在线<?php }?></td>
						  <td><?php echo isset($r['kf_id'])?$r['kf_id']:'';?></td>
                          <td><?php echo isset($r['accepted_case'])?$r['accepted_case']:'';?></td>
                      </tr>
                     <?php $no++;}?>
                     <tr>
                     	<td colspan="5">
