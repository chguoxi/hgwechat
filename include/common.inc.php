...
if (!isset($_SESSION) || !$_SESSION){	session_start();}
define('IN_SYS',true);
...
define('ADMIN_FILE', 'useradmin.php');
/**
 ...
 * 配置文件
 */
//$appinfo = phpWeChat\Apps::getAppInfoByHostname();
$appid = phpWeChat\Apps::getCurrAppId();
//print_r($appid);exit;
$PW=phpWeChat\Config::loadConfig($appid);
