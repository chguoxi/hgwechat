...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="{__PW_PATH__}{__ADMIN_FILE__}?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">安全验证</span></div>
        </div>
                ...
                <div class="config-items">
                    ...
                    <div class="result-content">
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    <th class="formth" width="20%"><img src="{__PW_PATH__}statics/images/360.gif"></th>
                                    <td class="formtd">
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                ...
                                <tr class="formtr" style="display:none">
                                    ...
                                    <td class="formtd"><input type="text" value="{$PW['admin_file']}" size="24" name="info[admin_file]" class="common-text"></td>
                                </tr>
								-->
                                <tr class="formtr">
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    宽 <input type="text" value="{$PW['captcha_width']}" size="4" name="info[captcha_width]" class="common-text"> Px
                                    &nbsp;&nbsp;
                                    高 <input type="text" value="{$PW['captcha_height']}" size="4" name="info[captcha_height]" class="common-text"> Px
                                    </td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth">验证码长度设置：</th>
                                    <td class="formtd">
                                    <input type="text" value="{$PW['captcha_len']}" size="4" name="info[captcha_len]" class="common-text"> 个字符
                                    </td>
                                </tr>
                                <tr class="formtr">
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" value="{$PW['cookie_domain']}" size="24" name="info[cookie_domain]" class="common-text">
                                    <br>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" value="{$PW['cookie_path']}" size="4" name="info[cookie_path]" class="common-text">
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" value="{$PW['cookie_pre']}" size="24" name="info[cookie_pre]" class="common-text">
                                    </td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth">Cookie生命周期：</th>
                                    <td class="formtd">
                                    <input type="text" value="{$PW['cookie_ttl']}" size="4" name="info[cookie_ttl]" class="common-text"> 秒
