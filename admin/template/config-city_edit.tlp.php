...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="{__PW_PATH__}{__ADMIN_FILE__}?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">编辑城市</span></div>
        </div>
            ...
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <div class="config-items">
                    <div class="config-title">
                        <h1><i class="icon-font">&#xe026;</i>编辑城市</h1>
                    </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[spell]" value="{$_data['spell']}" size="36" />
                                ...
                                <tr class="formtr">
                                    ...
                                    <select name="info[proid]">
                                    	{loop Area::proList() $r}
                                        <option value="{$r['id']}" {php echo $_data['proid']==$r['id']?'selected':'';}>{$r['name']}</option>
                                        {/loop}
                                    </select>                                    
                                    </td>
                                </tr>
