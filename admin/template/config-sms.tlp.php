...
<body>
    <div class="ifame-main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="{__PW_PATH__}{__ADMIN_FILE__}?file=index&action=main">管理首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">短信配置</span></div>
        </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[sms_target]" value="{$PW['sms_target']}" size="60" />
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="info[sms_account]" value="{$PW['sms_account']}" size="16" />
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd">
                                    <input type="password" class="common-text" name="info[sms_pwd]" value="{$PW['sms_pwd']}" size="16" />
                                    </td>
                                </tr>
                                <tr class="formtr">
                                    <th class="formth"><i class="require-red">*</i>短信发送模板：</th>
                                    <td class="formtd">
                                   <textarea class="common-textarea" cols="75" rows="5" name="info[sms_template]">{$PW['sms_template']}</textarea></td>
                                    </td>
                                </tr>
                            </tbody></table>
                    </div>
